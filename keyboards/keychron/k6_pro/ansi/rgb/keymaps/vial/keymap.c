...
[LAYER_0] = LAYOUT_ansi_68(
     ...
     KC_LCTRL, KC_LGUI,  KC_LALT,                                KC_SPC,                       KC_RALT,  MO(1),    MO(2),    KC_LEFT,  KC_DOWN, KC_RGHT),

[LAYER_1] = LAYOUT_ansi_68(
     KC_GRAVE, KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL,   KC_TRNS,
     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_NUHS,  KC_TRNS,
...
[LAYER_3] = LAYOUT_ansi_68(
     RESET,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
     RGB_TOG,  RGB_MOD,  RGB_HUI,  RGB_SAI,  RGB_VAI,  RGB_SPI,  RGB_M_P,  RGB_M_B,  RGB_M_R,  RGB_M_SW, RGB_M_SN, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
